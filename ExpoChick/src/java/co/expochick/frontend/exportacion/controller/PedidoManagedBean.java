...
import co.expochick.backend.persistence.facades.PedidoFacadeLocal;
...
public class PedidoManagedBean implements Serializable{
   ...
   @EJB private PedidoFacadeLocal pedfcl;
