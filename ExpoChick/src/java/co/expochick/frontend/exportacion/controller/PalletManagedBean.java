...
import co.expochick.backend.persistence.facades.PalletFacadeLocal;
...
public class PalletManagedBean implements Serializable{
    ...
    @EJB private PalletFacadeLocal pllfcl;
