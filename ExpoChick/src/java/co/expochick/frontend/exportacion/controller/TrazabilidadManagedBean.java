...
import co.expochick.backend.persistence.facades.TrazabilidadFacadeLocal;
...
public class TrazabilidadManagedBean implements Serializable{
    ...
    @EJB private TrazabilidadFacadeLocal trafcl;
