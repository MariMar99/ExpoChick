...
import co.expochick.backend.persistence.facades.EstadoClienteFacadeLocal;
...
public class estadoClienteManagedBean {
    ...
    @EJB private EstadoClienteFacadeLocal estClifcl;
